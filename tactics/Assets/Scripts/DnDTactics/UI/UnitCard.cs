...
namespace DnDTactics.UI
{
	...
	/// </summary>
	public class UnitCard : Universal.UI.UIPanel
	{
		...
		public override void Draw()
		{
			...
			if (unitClass) unitClass.text = DataManager.GetClassDisplayName((Unit.Extensions as IDetails).Class);
